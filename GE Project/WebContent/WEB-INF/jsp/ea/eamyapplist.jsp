...
//	groupSize = Integer.parseInt(groupSize1);
	...
	System.out.println("(ealist.jsp)curPage : " + curPage);
	System.out.println("(ealist.jsp)groupSize : " + groupSize);
	System.out.println("(ealist.jsp)pageNo : " + pageNo);
	System.out.println("(ealist.jsp)totalCount : " + totalCount);
%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=EUC-KR">
		<title>eaMyAppList.jsp</title>
...
//				$("#ea_detailsend").attr("target", "pop");
	...
	<body>
		...
		<div class="ge_maindiv">
			<form name="ea_detailsend" id="ea_detailsend">
				...
				<div class="outertable">
					...
					<div class="ge_sidemenu">
						...
						<a href="/ea/eamyapplist.ge" onclick="loading();" style="color:#615F8D">결재요청문서</a><br>
						</div>
		...
		<form id="ea_mylistform" name="ea_mylistform">
			<div class="tit"><div class="title">&nbsp;결재 요청</div></div>
