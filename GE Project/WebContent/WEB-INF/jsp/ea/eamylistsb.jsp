...
//	groupSize = Integer.parseInt(groupSize1);
	...
	System.out.println("(eamylistsb.jsp)curPage : " + curPage);
	System.out.println("(eamylistsb.jsp)groupSize : " + groupSize);
	System.out.println("(eamylistsb.jsp)pageNo : " + pageNo);
	System.out.println("(eamylistsb.jsp)totalCount : " + totalCount);	
%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=EUC-KR">
		<title>eamylistsb.jsp</title>
...
<!-- 		<form name="ge_main" id="ge_main">
				...
				<div class="outertable">
					...
					<div class="ge_sidemenu">
						...
						<div class="menubtn">
						<div class="mbtneff"></div>
						<a href="/ea/eamylistsb.ge" onclick="loading();" style="color:#615F8D">대기</a><br>
						</div>
	...
	<form id="ea_detailsend" name="ea_detailsend">
		...
		<form id="ea_mylistform" name="ea_mylistform">
			<div class="tit"><div class="title">&nbsp;MY LIST : 대기</div></div>
