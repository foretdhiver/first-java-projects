...
//	groupSize = Integer.parseInt(groupSize1);
	...
	System.out.println("(eamylistpg.jsp)curPage : " + curPage);
	System.out.println("(eamylistpg.jsp)groupSize : " + groupSize);
	System.out.println("(eamylistpg.jsp)pageNo : " + pageNo);
	System.out.println("(eamylistpg.jsp)totalCount : " + totalCount);	
%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=EUC-KR">
		<title>eamylistpg.jsp</title>
...
//				$("#ea_detailsend").attr("target", "pop");
		...
		<!-- <form name="ge_main" id="ge_main">
				...
				<div class="outertable">
					...
					<div class="ge_sidemenu">
						...
						<div class="menubtn">
						<div class="mbtneff"></div>
						<a href="/ea/eamylistpg.ge" onclick="loading();" style="color:#615F8D">진행</a><br>
						</div>
	...
	<form id="ea_detailsend" name="ea_detailsend">
		...
		<form id="ea_mylistform" name="ea_mylistform">
			<div class="tit"><div class="title">&nbsp;MY LIST : 진행</div></div>
