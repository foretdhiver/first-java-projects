...
// eaWriteEnd 정보
Object object = request.getAttribute("eaWriteEnd");
List<EaVO_> eaWriteEnd = (List<EaVO_>) object;
System.out.println("eaWriteEnd : " + eaWriteEnd);
System.out.println("eaWriteEnd.size() : " + eaWriteEnd.size());
				...
				<div class="outertable">
					<div class="ge_sidemenu">
						...
						<div class="mainframe1">
							<div class="tit1"><div class="title">&nbsp;내 완료 문서리스트</div></div> <!-- tit1 -->
							<div class="tableContainer1">
				           		<table class="ea_mylist1">
									...
									<%
	if(eaWriteEnd.size() > 0){
		for(int i=0; i < eaWriteEnd.size(); i++){
			EaVO_ evo = (EaVO_)eaWriteEnd.get(i);
...
%>
					            ...
					            <div class="paging_container" style="position: botton:0px; margin:middle;">
									...
									<jsp:param name="url" value="/ea_/eaWriteEnd.ge"/>
