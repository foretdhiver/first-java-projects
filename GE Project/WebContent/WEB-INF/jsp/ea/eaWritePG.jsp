...
//eaWritePG 정보
Object object = request.getAttribute("eaWritePG");
List<EaVO_> eaWritePG = (List<EaVO_>) object;
System.out.println("eaWritePG : " + eaWritePG);
System.out.println("eaWritePG.size() : " + eaWritePG.size());
...
//					alert("r_arr[1] : " + r_arr[1]);
				...
				<div class="outertable">
					<div class="ge_sidemenu">
						...
						<div class="mainframe1">
							<div class="tit1"><div class="title">&nbsp;내 진행 문서리스트</div></div> <!-- tit1 -->
	...
	if(eaWritePG.size() > 0){
		for(int i=0; i < eaWritePG.size(); i++){
			EaVO_ evo = (EaVO_)eaWritePG.get(i);
...
%>
					            ...
					            <div class="paging_container" style="position: botton:0px; margin:middle;">
									...
									<jsp:param name="url" value="/ea_/eaWritePG.ge"/>
