			...
			<div>
				...
				%>
					...
					<tr>
						...
						<td><input type="text" name="kno" id="kno" value="<%= kvo.getKno() %>" size="20"></td>
					</tr>
					<tr>
						<td align="center">제목</td>
						<td><input type="text" name="ksubject" id="ksubject" value="<%= kvo.getKsubject() %>" size="20"></td>
					</tr>
					<tr>
						<td align="center">작성자</td>
						<td>
							<input type="text" name="kname" id="kname" value="<%= kvo.getKname() %>" size="20">
							
						</td>
					</tr>
					<tr>
						<td align="center">비밀번호</td>
						<td><input type="password" name="kpw" id="kpw" value="<%= kvo.getKpw() %>" size="20"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><img src="/<%= kvo.getKimage() %>" width="300px"><input type="file" name="fileName1" id="fileName1"></td>
					</tr>
					<tr>
						<td colspan="2" align="center">
							<textarea name="kmemo" id="kmemo" rows="25" style="width:98%;" class="js-sms-content"><%= kvo.getKmemo() %></textarea>
