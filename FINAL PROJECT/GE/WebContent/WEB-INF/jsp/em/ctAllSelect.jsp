...
//System.out.println("ctstdate / cteddate >>> : " + ctstdate + " / " + cteddate);
...
%>
		...
		<script type="text/javascript">
			...
			function ctDetailFunction(emno){
				//alert(emno);
				$("#emno").val(emno);
				window.open("/em/ctSelect.ge", "pop", 'width='+ popW +',height='+ popH +',top='+ posT +',left='+ posL +',resizable=no,scrollbars=no');
				$("#searchForm").attr("action", "/em/ctSelect.ge");
				$("#searchForm").attr("target", "pop");
				$("#searchForm").submit();
			}
		</script>
	</head>
					...
					<div class="datesearch">
						<!-- select -->
							<select id="search" name="search">
								...
								<option value="dateSearch">기간</option>
							</select>
						
						<!-- 시작일 -->
						<span class="dset">
							<input type="text" class="datepicker inpType" id="ctstdate" name="ctstdate">
							<a href="#none" class="btncalendar dateclick">달력</a>
						</span>
						<span class="demi">~</span>
						<!-- 종료일 -->
              			<span class="dset">
							<input type="text" class="datepicker inpType" id="cteddate" name="cteddate">
							<a href="#none" class="btncalendar dateclick">달력</a>
						</span>
							&nbsp;&nbsp;
...
%>			
						...
						<div class="paging_container" style="position: botton:0px; margin:middle;">
							...
							<jsp:param name="url" value="/em/ctAllSelect.ge"/>
