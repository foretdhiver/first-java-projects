								...
								<td>
									<div id="UpDelbutton" style="margin:0px 0px 0px 0px;">
										<table border="0px">
											<tr>
												<td align="right">
												<input type="button" class="button" value="글수정하기" id="BDUForm" name="BDUForm"> 
...
%>
										...
										<tr height="10px">
											<td align="left" colspan="3">
												<input type="button" class="button" value="글쓰기" id="BDInsert" name="BDInsert"> 
												<input type="button" class="button" value="답글" id="RefBInsert" name="RefBInsert">
											</td>
											<td align="right" colspan="3">
												<input type="button" class="button" value="목록으로 돌아가기" id="BDList" name="BDList">
											</td>
										</tr>
										<tr>
										<!-- 댓글 -->
