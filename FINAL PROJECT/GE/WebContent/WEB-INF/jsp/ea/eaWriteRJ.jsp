...
//eaWriteRJ 정보
Object object = request.getAttribute("eaWriteRJ");
List<EaVO_> eaWriteRJ = (List<EaVO_>) object;
System.out.println("eaWriteRJ : " + eaWriteRJ);
System.out.println("eaWriteRJ.size() : " + eaWriteRJ.size());
...
//					alert("r_arr[1] : " + r_arr[1]);
				...
				<div class="outertable">
					<div class="ge_sidemenu">
						...
						<div class="mainframe1">
							<div class="tit1"><div class="title">&nbsp;내 반려 문서리스트</div></div> <!-- tit1 -->
	...
	if(eaWriteRJ.size() > 0){
		for(int i=0; i < eaWriteRJ.size(); i++){
			EaVO_ evo = (EaVO_)eaWriteRJ.get(i);
