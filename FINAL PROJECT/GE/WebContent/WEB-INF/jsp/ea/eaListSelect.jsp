...
Object object = request.getAttribute("eaList");
List<EaVO_> eaList = (List<EaVO_>) object;
System.out.println("eaList : " + eaList);
System.out.println("eaList.size() : " + eaList.size());
	...
	<script type="text/javascript">
		...
		//	alert($('#ea_stepno').val());
			...
			$(".goDetail").click(function(){
           		...
           		loading();
           		$("#eadetailSend").attr("action", "/ea_/eaDetail.ge").submit();
           	});
				...
				<div class="outertable">
					<div class="ge_sidemenu">
						...
						<div class="mainframe1">
							<div class="tit1"><div class="title">&nbsp;진행 결재문서리스트</div></div>
...
%>
								<tr>
									<td colspan ="6" align="center">결재할 결재문서가 없습니다.</td>
								</tr>
<%
	}
%>
					            ...
					            <div class="paging_container" style="position: botton:0px; margin:middle;">
									...
									<jsp:param name="url" value="/ea_/eaListSelect.ge"/>
