...
<%
	...
	System.out.println("(eamylist.jsp)curPage : " + curPage);
	System.out.println("(eamylist.jsp)groupSize : " + groupSize);
	System.out.println("(eamylist.jsp)pageNo : " + pageNo);
	System.out.println("(eamylist.jsp)totalCount : " + totalCount);	
%>
...
<html>
	...
	//	      $( "#scroll" ).stop().animate({top:position+"px"}, 1); //해당 오브젝트 위치값 재설정   
	//	});
...
//			$("#ge_main").attr("target", "pop");
			...
			<form name="ge_main" id="ge_main">
				...
				<div class="outertable">
					...
					<div class="ge_sidemenu">
						...
						<div class="menubtn">
						<div class="mbtneff"></div>
						<a href="/ea/eamylistall.ge"  onclick="loading();"style="color:#615F8D">전체</a><br>
						</div>
	...
	<form id="ea_detailsend" name="ea_detailsend">
		<input type="hidden" name="ea_no" id="ea_no">
		<input type="hidden" name="ea_stepno" id="ea_stepno">
		<input type="hidden" name="curPage" id="curPage" value="<%=curPage1%>">
	</form>
		<form id="ea_mylistform" name="ea_mylistform">
			<div class="tit"><div class="title">&nbsp;MY LIST</div></div>
