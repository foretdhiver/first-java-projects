		...
		//	alert($('#ea_stepno').val());
			...
			$("#app").click(function(){
				if(confirm('해당 문서를 승인하시겠습니까?')){
					if($("#ea_status").val()=="01"){
	    				var statusVal = "02";
	            		$("#ea_status").val(statusVal);
	    			}else if($("#ea_status").val()=="02"){
	    				var statusVal = "03";
	            		$("#ea_status").val(statusVal);
	    			}else if($("#ea_status").val()=="05"){
	    				if($("#emno").val() == $("#ea_empno1").val()){
	    					$("#ea_status").val("02");
//	    					alert($("#ea_status").val());
	    				}
	    				if($("#emno").val() == $("#ea_empno2").val()){
	    					$("#ea_status").val("03");
//	    					alert($("#ea_status").val());
	    				}
	    			}
//	        		alert($("#ea_status").val());
	    			$("#eaUpdateForm").attr("action", "/ea_/eaUpdate.ge").submit();
				}else{
		...
		<table id="outlinetable" class="eawritetable">
			<tr>
				...
				<tr>
					...
					<tr>
						<td id="eabutton" colspan="4" align="center">
				...
				<td>
					...
					<tr>
						<td id="eabutton" colspan="4" align="center">
							...
							<input type="button" class="button" id="rj" name="rj" value="반려">
							<input type="button" class="button" id="st" name="st" value="대기">
							<input type="hidden" class="button" id="emno" name="emno" value="<%=emno%>">
						</td>
					</tr>
				</table>
				</div>
