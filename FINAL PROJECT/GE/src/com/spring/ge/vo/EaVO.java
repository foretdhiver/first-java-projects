...
import com.spring.ge.vo.CommonVO;
	 ...
	 *  작성자    : 김연정
	 *  수정일자 : 2020-03-20 (금)
	 *  클래스 역활 : 전자결재(파일업로드형식) 통합 VO 테이블
	 *  
	 */
public class EaVO extends CommonVO{
	/* 여기부터 결재라인 테이블 컬럼 */
	...
	private String ea_subject;		//EA_SUBJECT		전자결재제목
	private String ea_memo;			//EA_MEMO			전자결재내용
	private String ea_fileupload;	//EA_FILEUPLOAD		전자결재문서파일업로드
	private String ea_insertdate;	//EA_INSERTDATE		품위일
	private String ea_nextemno;		//EA_NEXTEMNO       다음결재자
	/* 여기서부턴 하늘씨꺼임 */
