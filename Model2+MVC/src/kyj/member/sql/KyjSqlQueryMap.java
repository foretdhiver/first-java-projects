...
public abstract class KyjSqlQueryMap {
	...
	public static String getUpdateQuery(){ //WITH IMAGE
		StringBuffer sb = new StringBuffer();
		sb.append("UPDATE  							\n");
		sb.append("	KYJ_MEMBER A					\n");
		sb.append("SET      A.KPW = ?				\n");
	...
	public static String getUpdateQuery1(){ //WITHOUT IMAGE
		StringBuffer sb = new StringBuffer();
		sb.append("UPDATE  							\n");
		sb.append("	KYJ_MEMBER A					\n");
		sb.append("SET      A.KPW = ?				\n");
	...
	public static String getSelectQuery(){
		...
		sb.append("	,A.KIMAGE    KIMAGE		\n");
		sb.append(" ,A.KJUSO1	 KJUSO1		\n");
	...
	// 아이디 체크
	public static String idValueCkeck(){
		StringBuffer sb = new StringBuffer();
		sb.append("SELECT						\n");
		sb.append("	A.KID      KID				\n");
		sb.append("FROM    KYJ_MEMBER A			\n");
	...
	// 비번 체크
	public static String pwValueCkeck(){
		StringBuffer sb = new StringBuffer();
		return sb.toString();
	}
