...
<html>
	<head>
		...
		<title>SelectKyjMember.jsp</title>
		<!-- 
		...
		<form name="selectForm" 
			...
			<table border="1" width="450px"align="center">
				...
				<tr>
					...
					<td width="250">
					<input type="hidden" name ="kmem" id ="kmem">
				...
				<tr>
					...
					<font size="1"> *필수입력 검색과 수정할 때 쓰입니다 </font></td>
				</tr>
					<tr>
				...
				<tr>
					<td colspan="2">
						<center><img src="/<%=kvo.getKimage() %>" alt="이미지가 없습니다" border=0 width="200px" height="200px"></center>
					</td> 
				</tr>
				<tr>
					<td colspan="2" align="center">
						...
						<input type="button" value="메인" id="M">
					</td>
				</tr>
			</table>
			<%
